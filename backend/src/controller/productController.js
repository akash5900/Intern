...
export async function updateProduct(req, res) {
    try {
        ...
        const updatedProduct = await productModel.findByIdAndUpdate(id, { name: req.body.name, price: req.body.price, description: req.body.description, category: req.body.category, image: req.body.image }, { new: true }).populate("category");
